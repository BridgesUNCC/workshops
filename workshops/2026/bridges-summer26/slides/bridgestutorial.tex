...
\author{Kalpathi Subramanian, Erik Saule, Jamie Payton\\\texttt{krs@charlotte.edu}, \texttt{erik.saule@gmail.com}}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item BRIDGES on Windows: Use WSL (Windows subsytem for Linux) and a C++
			IDE for running BRIDGES
	\end{itemize}
...
\end{columns}
\href{http://bridges-cs.herokuapp.com/assignments/138/kalpathi60}{\color{purple} \bf [Another example that shows movies of Kevin Bacon]}
\end{block}
\end{frame}
