...
\subtitle{}
\author{Kalpathi Subramanian, Erik Saule\\\texttt{krs@charlotte.edu}, \texttt{erik.saule@gmail.com}}
\institute{The University of North Carolina at Charlotte}
\date{BRIDGES Workshop, June 15-17, 2026}

\setbeamertemplate{footline}

\usepackage{hyperref,graphicx,tabularx}
\usepackage{subfloat}
...
\end{itemize}
  \begin{columns}
    \begin{column}{.47\linewidth}
      \begin{block}{\href{https://assignments.bridgesuncc.org/assignments/105/kalpathi60}{\underline{Indexing USGS Earthquake}}}
...
\item Data is everywhere, the \textbf{harder part is} 
	\begin{itemize}
		\item Accessing data in a \textbf{ready-to-use form} for course work
		\item Mapping the right data to course work to \textbf{meet learning objectives}.
	\end{itemize}
\item BRIDGES supports a number of datasets ready to use in early CS courses:
	...
	\item Additional datasets/applications we will look at later in the workshop
...
\begin{frame}{Results [Longitudinal]: Students in BRIDGES sections progressed faster in CS}
  \begin{figure}[htp]
    \centering
  ...
  \end{figure}
\end{frame}
\begin{frame}{Impact of BRIDGES}
\begin{itemize}
\item We have an active user base
\item Demonstrated knowledge gains, longitudinal studies
\item Extensive survey data collected shows highly positive response to tools
\item Developed over 70 BRIDGES assignments for easy adoption by instructors
\item Over 10,000 BRIDGES assignments completed over the years, 
25+ universities, colleges, high schools have participated
\end{itemize}
\centering
\includegraphics[width=0.45\linewidth]{fig/AssignmentCount.pdf}
\includegraphics[width=0.45\linewidth]{fig/UserCount.pdf} \\
\end{frame}
\begin{frame}{ITCS 4114: Real World Algorithms}
\begin{block}{Junior/Senior Level Elective}
\begin{table}
\scriptsize
\begin{tabularx}{\textwidth}{p{0.4\textwidth}p{0.30\textwidth}p{0.20\textwidth}}
\multicolumn{1}{l}{\textbf{Module Content}}&\multicolumn{1}{l}{\textbf{Potential Assignments}}& \multicolumn{1}{l}{\textbf{Datasets}}\\ \hline
%
1. Data Structure Review, Math in Alg., BRIDGES setup & 
\textbf{Linked list of US cities, Family Tree} & 
US City data\\ \hline 
%
2. Comp. Complexity, Sorting Alg:, Quadratic and $n\, \lg \,n$ Alg. (Mergesort, quicksort)) & 
\textbf{Benchmarking Sorting Alg. (Quadratic vs N Log N Alg.} & Randomly generated\\ \hline
3. Graph Represntations, Traversals (BFS, DFS) & 
\textbf{DFS/BFS, Bacon Number/Path Computation} & IMDB Actor Movies, Wikidata\\\hline 
%
4. Advanced Graph Algorithms  (Topological Sort, Dijkstra's Shortest Path, Prim's Minimum Spanning Tree (MST) & 
\textbf{Prim's MST using US Cities, Dijkstra's SSP using OpenStreetMap data, Mountain Path using Elevation data} & 
US Cities, OpenStreet Maps, Elevation Data\\ \hline 
%
5. Searching and Indexing: Binary Search, Search Trees:  Balanced Trees (AVL, Red-Black, Splay Trees), Range Search, Spatial (Quadtree, K-d Trees, Bintree) &
\textbf{AVL Tree Balancing, Quadtree Constr/Search on US cities}  & 
US Cities\\ \hline
%
6. Geometric Algorithms: Closest Pair, Convex Hull, Voronoi Diagram &  
\textbf{Convex Hull of US Cities, Voronoi diagram} & 
US Cities, Images\\ \hline
%
8. Dynamic Programming: Knapsack, Warshall's Transitive Closure, Floyds All-Pairs Shortest Paths & 
\textbf{Least Effort (shortest path) on Elevation Data Using Dynamic Prog Alg.} &
Elevation data \\\hline
\end{tabularx}
\end{table}
\end{block}
\end{frame}
