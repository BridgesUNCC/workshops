...
\subtitle{}
\author{Kalpathi Subramanian, Erik Saule\\\texttt{krs@charlotte.edu}, \texttt{esaule@charlotte.edu} }
...
\begin{frame}
  \frametitle{Reddit}
  \includegraphics[width=0.45\linewidth]{dataset_figs/reddit1.png}
  \includegraphics[width=0.45\linewidth]{dataset_figs/reddit2.png}
\end{frame}
...
\begin{itemize}
	\item Structured by course and topics: 
  \href{http://bridgesuncc.github.io/newassignments.html}{\color{purple} \bf [BRIDGES Assignments]}
	\item  By course/learning outcomes:
	\href{../assignment_groups/assignmentgroups.pdf}{\color{purple}\bf [PDF]}
\end{itemize}
